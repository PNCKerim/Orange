...
module.exports = {
  name: 'rps',
    ...
    else if (botChoice > userChoice || botChoice === 0 && userChoice === 2) result = '**Orange** wins!';
    else result = `**${message.member.displayName}** wins!`;
    const embed = new MessageEmbed()
      .setTitle(`${message.member.displayName} vs. Orange`)
      .addField('Your Choice:', res[userChoice], true)
      .addField('Orange\'s Choice', res[botChoice], true)
